...
Revision ID: 742d71c22de0
Revises: aa5bb4b43372
Create Date: 2022-02-25 18:39:12.760140
...
revision = '742d71c22de0'
down_revision = 'aa5bb4b43372'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('manufaturer', sa.String(length=80), nullable=True),
    ...
    sa.Column('max_atmosfering_speed', sa.String(length=80), nullable=True),
